...
export const SalarioMinimo = ({
  ...
  return (
    <Container onBlur={calculate}>
      <Title>{getFieldName(labelsEnum.FEE, nomenclatures)} em Salario Minimo</Title>
      <Content>
        <Data>
          <DateContainer>
            <DefaultDateInput
              disabled={!values.isCalc || disabled}
              label="Data da condenacao"
              name="date"
              className="tax"
            />
          </DateContainer>
          ...
          <CheckboxContainer>
            <CheckboxLabel htmlFor="">
              {getFieldName(labelsEnum.VALUE, nomenclatures)} em quantidade de salarios
            </CheckboxLabel>
            <CheckboxContentContainer>
              <CustomCheckbox
                disabled={disabled}
          ...
          <DataResult>
            <BorderContainer>
              ...
              <DataChildren> (1 Salario = {valueWithCurrency('R$ ', values.minimumWage)})</DataChildren>
            </BorderContainer>
          </DataResult>
        </Data>

        <Title className="table">Tabela de Salario Minimo</Title>
        <Separator />

...
const FeeNewCpcModal = ({ nomenclatures }: { nomenclatures: INomenclature[] }): JSX.Element => {
  ...
  const initialValuesSM = {
    ...
    valueByTax0: 0,
    desc1: 'de 200 Ate 2.000 Salarios (8% - 10%)',
    ...
    valueByTax1: 0,
    desc2: 'de 2.000 Ate 20.000 Salarios (5% - 8%)',
    ...
    valueByTax2: 0,
    desc3: 'de 20.000 Ate 100.000 Salarios (3% - 5%)',
    ...
    valueByTax3: 0,
    desc4: 'acima de 100.000 Salarios (1% - 3%)',
    ...
    <DefaultModal
      ...
      <Container>
        {values.isOpenFeeConfig && (
          <Fragment>
            <MainCalc>
              <Title>Configuracoes dos {getFieldName(labelsEnum.FEE, nomenclatures)}</Title>
              ...
              <Content>
                <FlexContainer>
                  <CheckboxContainer>
                    ...
                    <Text>(Soma do principal sem considerar as demais ocorrencias)</Text>
                  </CheckboxContainer>

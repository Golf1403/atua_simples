...
import { FeeFineTypes, typeFee, typeFeeArt, typeFine, typeFineArt } from '@/hooks/interfaces/CurrentAccountHookImp';
import {
  ButtonActionDefault,
  coloraero,
  colorbabyponder,
...
`;
export const BackgroudContainer = styled.div<{ align: 'center' | 'flex-end' }>`
  display: -webkit-box;
  display: -webkit-flex;
  display: -moz-flex;
  display: -ms-flex;
  display: -o-flex;
  display: flex;
  -webkit-justify-content: ${props => props.align};
  -moz-justify-content: ${props => props.align};
  -ms-justify-content: ${props => props.align};
